-- =========================================================================
-- CƠ SỞ DỮ LIỆU CHÍNH THỨC 8 BẢNG - CÔNG ĐOÀN ĐẠI HỌC THỦ DẦU MỘT (TDMU)
-- Chuẩn hóa quan hệ 3NF toàn vẹn dữ liệu (MySQL / phpMyAdmin / Laragon)
-- Hỗ trợ utf8mb4, FOREIGN KEY ON DELETE CASCADE, AUTO_INCREMENT
-- =========================================================================
...
-- 1. BẢNG TO_CHUC (Cơ cấu tổ chức BCH, BTV, UBKT, các ban chuyên môn)
...
-- 2. BẢNG TO_CONG_DOAN (16 Tổ Công đoàn trực thuộc TDMU)
...
-- 4. BẢNG TIN_TUC (Bài viết truyền thông, tin tức, nội dung đa kênh AI)
...
-- 5. BẢNG VAN_BAN (Văn bản chỉ đạo, công văn, kế hoạch, quyết định)
...
-- 6. BẢNG BAO_CAO_THANG (Báo cáo hoạt động định kỳ & thi đua của 16 Tổ công đoàn)
...
-- 7. BẢNG LICH_XUAT_BAN (Lên lịch hẹn giờ đăng bài đa kênh tự động)
...
-- 8. BẢNG NHAT_KY (Nhật ký tác nghiệp, kiểm toán hành động & bảo mật)
...
-- Nạp 3. NHAN_SU (Phân quyền 3 Role)
...
(1, 'SYSTEM_INIT', 'Khởi tạo hệ thống quản trị truyền thông công đoàn TDMU chuẩn 8 bảng', 'TS. Nguyễn Văn A'),
